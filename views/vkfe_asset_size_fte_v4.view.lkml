# The name of this view in Looker is "Vkfe Asset Size Fte V4"
view: vkfe_asset_size_fte_v4 {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: `ERCAssitbyBankAugust2023.VKFE_AssetSize_FTE_v4` ;;
  ...
  # define primary_key: yes on a dimension that has no repeated values.
    ...
    # This dimension will be called "As Vkfe Max Int" in Explore.

  dimension: as_vkfe_max_int {
    type: number
    sql: ${TABLE}.asVKFE_Max_int ;;
  }

  dimension: as_vkfe_min_int {
    type: number
    sql: ${TABLE}.asVKFE_Min_int ;;
  }
  ...
  dimension: asset_size_2023_03_31_int {
    type: number
    sql: ${TABLE}.AssetSize_2023_03_31_int ;;
  }
  ...
  dimension: asset_size_q12021_int {
    type: number
    sql: ${TABLE}.AssetSize_Q12021_int ;;
  }
  ...
  dimension: fte_q12021_int {
    type: number
    sql: ${TABLE}.FTE_Q12021_int ;;
  }
